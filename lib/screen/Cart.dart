                              ...
                              Expanded(
                                child: Column(
                                 children: [
                                  Text('₹${_prd.price}',
                                 style: TextStyle(
                                color: _prd.off > 0 ? Colors.red : Colors.black,
                                decoration: _prd.off > 0 ? TextDecoration.lineThrough
                ...
                BlocProvider.of<ProductBloc>(context).cartProducts.length>0
                  ? Card(
                      ...
                      child: Container(
                        ...
                        padding: EdgeInsets.all(12),
                        child: Text('Total Price: ₹ ${BlocProvider.of<ProductBloc>(context).cartProducts.reduce((val,
                        element)=>Product(price: val.price+(element.price - (element.price*element.off)))).price.toStringAsFixed(2)}',
